...
namespace SkyVoteTime.Server.Migrations
{
    ...
    [Migration("20230520013858_migSeraQueEDesta")]
    partial class migSeraQueEDesta
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkyVoteTime.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SkyVoteTime.Server.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SkyVoteTime.Server.Models.Movie", b =>
                {
                    b.HasOne("SkyVoteTime.Server.Models.Competition", null)
                        .WithMany("Movies")
